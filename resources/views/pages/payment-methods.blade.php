    ...
    <div class="max-w-4xl mx-auto px-4 sm:px-6 py-16">
        <div class="bg-white border border-slate-200 rounded-2xl p-8 sm:p-12 shadow-sm space-y-6">
            ...
            <div class="space-y-6 text-sm text-slate-650 leading-relaxed">
                <p>At Saffron Store, we support secure payment options to make buying simple and safe. We offer the following options at checkout:</p>
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6 pt-4">
                    ...
                    <div class="bg-slate-50 border border-slate-200 rounded-xl p-5 space-y-2">
                        ...
                        <p class="text-xs text-slate-500">Pay physically with cash when the courier partner delivers the products directly to your doorstep. (Maximum order limits may apply).</p>
                    </div>
                </div>
