    ...
    <form wire:submit="save" class="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div class="space-y-6">
            ...
            <div class="bg-slate-50 border border-slate-200 rounded-2xl p-5 space-y-3">
                <button type="submit" class="w-full rounded-xl bg-gradient-to-r from-indigo-500 to-purple-600 py-3 text-xs font-bold text-white shadow-md hover:from-indigo-600 hover:to-purple-705 transition text-center">
                    Publish Product
                </button>
